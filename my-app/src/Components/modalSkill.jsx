...
return(
    <>
            ...
            >
                <Button size="large" onClick={handleClose} p={2} sx={{color:'black',border:'1px solid black',fontWeight:'bolder',backgroundColor:'crimson',borderRadius:'17px 17px 17px 17px'}}>
                        <CancelIcon />
                </Button>
                ...
                <Typography component="motion.h2" bottom={17} position="fixed" sx={{fontStyle:'italic',fontWeight:'bolder',fontSize:{lg:'1.5rem',md:'1.4rem',sm:'1.3rem',xs:'1.2rem'}}}>"I possess strong {title} skills."</Typography>
            </motion.Box>
            </AnimatePresence>
    </>
)
