...
export default function Keycard({id,idp,name,link,des,remark,imag,col,photo,lang}) {
  ...
  return (
    <>
      <Box component={motion.Card} key={id} style={{ backgroundColor }} whileHover={{boxShadow:'7px 7px 10px white',scale:1.05}}
        ...
        <Box>
            <Typography gutterBottom variant="h5" fontWeight='bold' sx={{marginY:'1rem',justifyContent:'center',textAlign:'center'}} component="div">
                {name}
            </Typography>
        </Box>
        ...
        <CardContent sx={{backgroundColor:"black",color:'wheat'}}>
            <Typography mt={1} height={100} variant="body2" color="white">
              {des}
            </Typography>
        </CardContent>
        <Box p={1} sx={{justifyContent:'center',justifyContent:'center',textAlign:'center',fontSize:'2rem',zIndex:'1'}}>
