...
export default function Key() {
  ...
  const getload = async()=>{
      const response = await axios.get('http://127.0.0.1:8000/media/key');
  ...
  return (
    ...
    <Box component={motion.div} top={0} bottom={0} left={0} right={0}
        ...
        <Typography component={motion.h1} width='100%' m={5}
              // style={{
     ...
     <ul ref={ref} direction="row" style={{padding: '20px 20px',display:'flex',margin:'2rem', overflowX:'scroll',overflowY:'hidden',height:'fit-content'}}>
