...
import { Box, Grid, Typography, styled, Alert , AlertTitle, List ,ListItem ,createStyles, Card ,TextField,InputAdornment , Link , Button ,TextareaAutosize, Stack } from '@mui/material';
    ...
    {/* Whole Code */}
      ...
      <Box top={0} bottom={0} left={0} right={0}
        ...
        {/* <img className='imgbg' src={phot}>
          ...
          <Stack direction="row" sx={{overflow:"hidden",display:"flow",justifyContent:'center'}}>
            <List >
