        ...
        <Box component="img" className='moo' sx={{width:'100%',zIndex:'9999',backgroundSize:'cover',position:'absolute'}} src={imga}></Box>
            <Box
              component={motion.div}
                my={3}
                sx={{height:'fit-content',zIndex:'1',border:'0.1px solid black',zIndex:'9999',opacity:'0.7'}}
                className="mopop"
                initial="hidden"
                animate="visible"
                exit="exit"
            ...
            >
                ...
                <Box>
                  ...
                  <Box sx={{justifyContent:'center',textAlign:'center'}}>
                  {
                          ...
                          <Box p={1} sx={{justifyContent:'center',textAlign:'center',fontSize:'2rem',zIndex:'1'}}>
