...
export default function Work() {
  ...
  const getload = async () => {
    const response = await axios.get('http://127.0.0.1:8000/media/work');
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Container sx={{ backgroundColor: 'white', width: '90%', justifyContent: 'center', alignItems: 'center', position: 'relative', overflow: 'hidden', border: '0.009px solid black', height: '47vh', padding: "20px 10px" }}>
            {
              post.map(() => {
                return (
