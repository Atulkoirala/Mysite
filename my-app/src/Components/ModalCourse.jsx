        ...
        <AnimatePresence>
            ...
            >
                ...
                <Grid container p={2}sx={{marginY:{lg:'0.5rem',md:'0.4rem',sm:'0.3rem',xs:'0rem'}}} mx={5}>
                    <Grid sx={{height:{lg:'100%',md:'100%',sm:'100%',xs:'15%'},width:'100%',justifyContent:'center',alignItems:'center',margin:'auto'}} item lg={6} md={5} sm={6} xs={12}>
                        <Typography sx={{float:'left',fontWeight:'bold',fontSize:{lg:'1rem',md:'1rem',sm:'1rem',xs:'0.9rem'}}}>Date Passed:{fdate}</Typography>
                        <Box component="img" sx={{width:{lg:'70%',md:'100%',sm:'90%',xs:'0%'},justifyContent:'center',alignItems:'center',margin:'auto',borderRadius:'7px 7px 7px 7px'}} src={cert}></Box>
                    </Grid>
