...
class Program_Language(models.Model):
    ...
    Svg_Image = models.FileField(upload_to='media/plang',blank=False,validators=[validate_svg])
...
class Language(models.Model):
    ...
    Title = models.CharField(max_length=30,blank=False)
    Description = models.TextField(blank=False)
    Svg_Image = models.FileField(upload_to='media/Lang',blank=False,validators=[validate_svg])
...
class Carosel(models.Model):
    ...
    Image = models.ImageField(upload_to='media/carosel',blank=False)
...
class Keystone(models.Model):
    ...
    Image = models.ImageField(upload_to='media/Project',default='project.jpg')
...
class Courses(models.Model):
    ...
    Title = models.CharField(max_length=30,blank=False)
    Description = models.TextField(blank=False)
    Certificate = models.ImageField(upload_to='media/Course',blank=False)
    Pfd = models.FileField(upload_to='media/Course',blank=False,validators=[validate_pdf])
...
class Education(models.Model):
    ...
    img = models.ImageField(upload_to='media/education',blank=False)
...
class Worked(models.Model):
    ...
    From = models.DateField(default=timezone.now,blank=False)
    To = models.DateField(default=timezone.now,blank=False)
    img = models.ImageField(upload_to='media/work',blank=False)
...
class Skill(models.Model):
    ...
    Title = models.CharField(max_length=30,blank=False)
    Description = models.TextField(blank=False)
    Svg_Image = models.FileField(upload_to='media/Skill',blank=False,validators=[validate_svg])
    Image = models.ImageField(upload_to='media/Skill',default='skill.jpg',blank=False)
